...
namespace CloudPharmacy.PharmacyStore.API.Infrastructure.Services.Identity
{
    public interface IVerifiableCredentialsService
    {
        Task VerifyPatientCredentialAsync(HttpResponse httpResponse);
    }
    ...
    internal class VerifiableCredentialsService : IVerifiableCredentialsService
    {
        ...
        public async Task VerifyPatientCredentialAsync(HttpResponse httpResponse)
        {
           ...
           .ExecuteAsync();
            ...
            var response = await _httpClient.PostAsJsonAsync(_verifiableCredentialsServiceConfiguration.VerificationEndpointUrl,
                                                             patientProfileData,
                                                             options);
